              ...
              <ul className="footer-links footer-blog-entry list-unstyled">
                <li>
                  <a href="single-post.html" className="d-flex align-items-center">
                    <Image src="/images/post-sq-1.jpg" alt="" className="img-fluid me-3" width="250" height="250"/>
                    <div>
                      <div className="post-meta d-block"><span className="date">Culture</span> <span className="mx-1">&bullet;</span> <span>Jul 5th22</span></div>
                ...
                <li>
                  <a href="single-post.html" className="d-flex align-items-center">
                    <Image src="/images/post-sq-2.jpg" alt="" className="img-fluid me-3" width="250" height="250"/>
                    <div>
                      <div className="post-meta d-block"><span className="date">Culture</span> <span className="mx-1">&bullet;</span> <span>Jul 5th22</span></div>
                ...
                <li>
                  <a href="single-post.html" className="d-flex align-items-center">
                    <Image src="/images/post-sq-3.jpg" alt="" className="img-fluid me-3" width="250" height="250"/>
                    <div>
                      <div className="post-meta d-block"><span className="date">Culture</span> <span className="mx-1">&bullet;</span> <span>Jul 5th22</span></div>
                ...
                <li>
                  <a href="single-post.html" className="d-flex align-items-center">
                    <Image src="/images/post-sq-4.jpg" alt="" className="img-fluid me-3" width="250" height="250"/>
                    <div>
                      <div className="post-meta d-block"><span className="date">Culture</span> <span className="mx-1">&bullet;</span> <span>Jul 5th22</span></div>
