...
const SignUp = () => {
  ...
  }, [data, router, validatePassword, validateEmail])
          ...
          <div className="row">
            <div className="col-sm-6 mx-auto">
              ...
              <div className="mb-5 text-center">
                ...
                <button type="button" className="btn btn-dark m-1 col-2" style={{ height: '50px', fontWeight: 'bold' }} onClick={() => router.push('/')}>취소</button>
              </div>
            </div>
          </div>
        </div>
